...
import MovieVideos from "../src/components/movieVideos";
...
.add("Overview", () => (<MovieDetails movie={sample} />))
.add("Videos", () => (<MovieVideos movie={sample} />))


  storiesOf("Buttons/Cards", module)
  .addDecorator(story => (
    <MemoryRouter initialEntries={["/"]}>{story()}</MemoryRouter>
  ))
  ...
  storiesOf("Actors/Details", module)
  .addDecorator(story => (
    <MemoryRouter initialEntries={["/"]}>{story()}</MemoryRouter>
  ))
  .add("Card", () => <ActorCard actor={actor}/>)
  .add("Overview", () => <ActorDetails actor={actor}/>)
  .add("Grid List", () => <GridList movies={[sample, sample, sample,sample,sample,sample,sample,sample,sample,sample,sample,sample]}/>)
